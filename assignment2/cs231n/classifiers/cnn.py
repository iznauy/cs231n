...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        affine_out, affine_cache = affine_relu_forward(crp_out, W2, b2)
        ...
        dp, grads['W2'], grads['b2'] = affine_relu_backward(daffine_out, affine_cache)
        _, grads['W1'], grads['b1'] = conv_relu_pool_backward(dp, crp_cache)
